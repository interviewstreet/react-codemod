...
1. `git clone https://github.com/interviewstreet/react-codemod.git` or download a zip file from `https://github.com/interviewstreet/react-codemod/archive/master.zip`
